...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "What is the first element of the periodic table?", answers: ["Sodium", "Oxygen", "Nitrogen", "Helium"], correctAnswer: "Hydrogen"))
        list.append(Question(text: "What type of electrical charge does a neurton have?", answers: ["Negative", "Positive", "No charge"], correctAnswer: "No charge"))
